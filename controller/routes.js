...
router.post('/googleplaces', function (req, res) {
    // console.log(req.body);
...
router.post('/getnotches', function (req, res) {
    // console.log(req.body);
...
router.post('/usernotches', function(req, res) {
    console.log(req.body);
...
router.post('/deletenotch', function(req, res) {
